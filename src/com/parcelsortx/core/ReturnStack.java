...
public class ReturnStack {
	...
	/*
	 * Bu yığın, yanlış yönlendirilen veya teslim edilemeyen kargoları geçici olarak
	...
	public void push(Parcel parcel) {
		...
		System.out.println(RED + " Stack pushed :  " + parcel.getParcelID() + " " + "to" + " "
	...
	public Parcel pop() {
		...
		System.out
				.println(CYAN + "Popped parcel : " + " " + poppedParcel.getParcelID() + " " + "size : " + size + RESET);
		return poppedParcel;
	}
	...
	public void showAllParcels() {
		...
		while (current != null) {
			...
			System.out.println(RED + position + "." + pc.getParcelID() + " " + "to" + " " + pc.getDestinationCity()
					+ " " + "priority: " + pc.getPriority() + " " + "arrived at tick" + " " + pc.getArrivalTrick()
					+ RESET);
