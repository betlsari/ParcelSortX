...
import com.parcelsortx.core.ReturnStack;
...
public class StackTest {
	public static void main(String[] args) {
	    ...
	    public static void testPushOperations(ReturnStack stack, Parcel... parcels) {
	    ...
	    public static void testPopOperations(ReturnStack stack) {
	        System.out.println("\n=== Pop İşlemleri Testi ===");
	        while (stack.size() > 0) {
	            stack.pop();
	        }
	    ...
	    public static void testEmptyStackOperations(ReturnStack stack) {
	        System.out.println("\n=== Boş Stack Testleri ===");
